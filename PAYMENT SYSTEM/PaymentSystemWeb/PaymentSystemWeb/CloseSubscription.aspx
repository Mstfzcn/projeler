<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CloseSubscription.aspx.cs" Inherits="PaymentSystemWeb.CloseSubscription" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Abonelik Kapat</title>
    <style type="text/css">  
        .table-style {  
            width: 70%;  
            margin:auto;
    ...
    <div>
        ...
        <table class="table-style">  
            ...
            <tr>  
                ...
                <td style="text-align: left; vertical-align: top">  
                    <asp:Button ID="CloseSubscribtionButton" runat="server" BorderStyle="Solid" Font-Size="X-Large" Text="Abonelik Kapat" OnClick="CloseSubscribtionButton_Click"/>  
                </td> 
            </tr>   
            <tr> 
                <td colspan="3" style="text-align: center; vertical-align: top">  
            ...
            <tr>  
                <td colspan="3" style="text-align: center; vertical-align: top">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField  DataField="SubscriberId" HeaderText="Abone Numarası" />
            ...
            <tr>
                <td colspan="3" style="text-align: center; vertical-align: top">  
                    <asp:Label ID="LabelMsg" runat="server" Font-Size="X-Large"></asp:Label>  
                </td>
            </tr>
        </table> 
    </div>
