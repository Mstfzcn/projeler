#define ag_ismi "NetMASTER Uydunet-FFB8"  //Ağ Adı
#define ag_sifresi "fc7a1dbf2cef012f"     //Ağ Şifresi
#define IP "mustafa.kayramusteritakip.com"    //185.87.123.67
float sicaklik;
...
void sicaklik_yolla(float sicaklik){
 Serial.println(String("AT+CIPSTART=\"TCP\",\"") + IP + "\",80");  //sunucuya bağlanmak için bu kodu kullanıyoruz. 
 ...
 String yollanacakkomut = "GET /bilgiGuncelle.aspx?seraAd=AnaSera&seraSicaklik=";
